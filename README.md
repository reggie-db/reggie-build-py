...
```bash
2026-01-05 18:07:45 [INFO] sync - Syncing build-system
...
```bash
2026-01-05 18:07:45 [INFO] sync - Syncing member-project-dependencies
...
```bash
2026-01-05 18:07:45 [INFO] sync - Syncing member-project-tool
...
```bash
2026-01-05 18:07:45 [INFO] sync - Syncing ruff
...
```bash
2026-01-05 18:07:45 [INFO] sync - Syncing version
